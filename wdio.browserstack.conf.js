...
export const config = {
  ...
  baseUrl: `https://grants-ui-accessibility-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `grants-ui-accessibility-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `grants-ui-accessibility-tests-${process.env.ENVIRONMENT}`
        },
